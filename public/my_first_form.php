...
<label> Want to compose an email 
...
<textarea name="email body"></textarea>
 ...
 <form>
 	...
 	<label>
<input type="radio" name="q1" value="who cares">who cares</label>
 </p>
 <p>
